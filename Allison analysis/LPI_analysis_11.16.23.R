...
## Running an NMDS on the LPI data 
...
##############################################################
#here reading in the data 

# read in the tablet data (from Laura's collated dataset)


# read in the paper data 

# read in plot-wide environmental data (to relate to # of germinants)

#Step 1 - reformat the data 
